...
(56, 2, 'Leasing Agreement - Flat 5', '2025-03-23', '2025-04-05', 11700.00, 'Leasing Service', 'The lessee must maintain the cleanliness and safety of the flat during the lease period; The lessor agrees to inspect the property biannually and ensure that all appliances and utilities are functional and in good condition.', 'Admin Two', NULL, NULL, 'RentIt', '654 Maple St', '555-3344', NULL, 'APPROVED', 3),
(57, 1, 'Leasing small Flat ', '2025-03-23', '2025-03-27', 1400.00, 'Leasing Service', 'The lessee agrees to lease the flat for the specified duration and return the property in the same condition; The lessor will provide regular cleaning services every month and ensure the safety of the property throughout the lease term.', 'Admin One', NULL, NULL, 'FlatSolutions', '456 Oak St', '555-5678', NULL, 'APPROVED', 3),
(59, 1, 'Leasing small Flat ', '2025-03-24', '2025-03-28', 1400.00, 'Leasing Service', 'The lessee agrees to lease the flat for the specified duration and return the property in the same condition; The lessor will provide regular cleaning services every month and ensure the safety of the property throughout the lease term.', 'Admin One', NULL, NULL, 'FlatSolutions', '456 Oak St', '555-5678', NULL, 'APPROVED', 3);
...
(7, 'test', 'test@ex.com', '077777', 'user', '12345678');
...
--
ALTER TABLE `contract`
  MODIFY `contract_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
